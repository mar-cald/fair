...
| File | Contenuto |
|---|---|
| `index.qmd` | Home: dove mettere dati, codice e materiali (tre schede) e lo strumento "Hai un dubbio?" per cercare nel sito |
...
| `fair.qmd` | I principi FAIR, FAIR e GDPR, il Data Management Plan |
| `repository.qmd` | Dove archiviare e come scegliere il repository |
| `zenodo.qmd` | Depositare su Zenodo |
| `psycharchives.qmd` | Depositare su PsychArchives |
| `versioni.qmd` | Correzioni e nuove versioni dopo il deposito |
