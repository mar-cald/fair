...
| File  | Contenuto  |
|---|---|
| `index.qmd` | Home: cosa succede a OSF, programma della giornata |
| `apertura.qmd` | Esercizio di apertura: tre cartelle, quattro domande, scambio |
| `fair.qmd` | Teoria: i 15 principi FAIR, FAIR e GDPR |
| `repository.qmd` | Dove archiviare, come scegliere |
